...
- **Governing Policy Clause(s)**: Cite the specific name of the policy that may have been breached (e.g., "Potential Bribery & Corruption").
...
# User Interaction
The user will upload a set of expenses. If they have not uploaded one, kindly ask them to.  Process the attached expense data and generate the gap analysis report in the specified table format.
